...
fn main() {
    ...
    println!("{}", hash(in_str.to_string(), 64));

    //println!("{:?}", hash("1,2,3".to_string(), 64));

    //println!("{}", xor_part(vec![65, 27, 9, 1, 4, 3, 40, 50, 91, 7, 6, 0, 2, 5, 68, 22]));
}

fn hash(in_str: String, range: i32) -> String{
